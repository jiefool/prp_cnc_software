...
CurpCalculation = (function() {
  ...
  CurpCalculation.prototype._getFirstToFourthPosition = function() {
    ...
    if (this.paternalLname == '' && this.maternalLname == WITHOUT_MATERNAL_LNAME) {
      this.curp += '_ ';
    } else {
  ...
  CurpCalculation.prototype._getFifthToTenthPosition = function() {
    if (this.birthDate == '') {
      return this.curp = "" + this.curp + '_ _ _ _ _ _ ';
    } else {
  ...
  CurpCalculation.prototype._getEleventhPosition = function() {
    if (this.gender === MALE) {
      ...
      return this.curp = "" + this.curp + '_ ';
    }
  };

  CurpCalculation.prototype._getTwelvethToThirteenthPosition = function() {

    if (typeof this.birthState == 'undefined' || this.birthState == '')
      return this.curp = "" + this.curp + "_ _ ";
    else
